...
import { Search, Filter, Package, RefreshCcw, QrCode } from 'lucide-react';
...
export default function ItemsPage() {
  ...
  const getCategoryBadge = (category: string) => {
    ...
    }[category.toLowerCase()] || 'bg-gray-100 text-gray-800';
  ...
  const handleShowBarcode = (item: Item) => {
